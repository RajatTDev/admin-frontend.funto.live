...
const BdRedeemRequest = () => {
  const [type, setType] = useState(() => {
    return localStorage.getItem("bdRedeemTab") || "Pending";
  });

  const handleTabChange = (newType) => {
    setType(newType);
    localStorage.setItem("bdRedeemTab", newType);
  };
      ...
      <div className="page-title">
        <div className="row">
          <div className="col-12 col-md-6 order-md-1 order-last">
            <h3 className="mb-3 text-white">BD Redeem Request</h3>
          </div>
...
export default BdRedeemRequest;
